...
// Unit tests for the GetSnowflakeConfig function
func TestGetSnowflakeConfig(t *testing.T) {
	...
	t.Run("Valid configuration file", func(t *testing.T) {
		...
		validConfig := `{"snowflake_plugin_log_level": "debug"}`
		...
		config, err := GetSnowflakeConfig(configFilePath)
		if err != nil {
	...
	t.Run("Invalid file path", func(t *testing.T) {
		...
		_, err := GetSnowflakeConfig(configFilePath)
		if err == nil {
