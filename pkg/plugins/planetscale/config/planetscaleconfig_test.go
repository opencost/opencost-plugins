...
// Unit tests for the GetPlanetscaleConfig function
func TestGetPlanetscaleConfig(t *testing.T) {
	...
	t.Run("Valid configuration file", func(t *testing.T) {
		...
		validConfig := `{"planetscale_plugin_log_level": "debug"}`
		...
		config, err := GetPlanetscaleConfig(configFilePath)
		if err != nil {
	...
	t.Run("Invalid file path", func(t *testing.T) {
		...
		_, err := GetPlanetscaleConfig(configFilePath)
		if err == nil {
